        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
                <div className="bg-white rounded-2xl shadow-2xl p-12 text-center max-w-md">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Đang chuẩn bị chứng chỉ</h3>
                    <p className="text-gray-600">Vui lòng đợi trong khi hệ thống tạo chứng chỉ của bạn...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 flex items-center justify-center">
                <div className="bg-white rounded-2xl shadow-xl p-8 text-center max-w-md">
                    ...
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Rất tiếc! Đã xảy ra lỗi</h3>
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-8">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-xl text-gray-600">Bạn đã nhận được chứng chỉ hoàn thành!</p>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                        ...
                        <div className="relative p-16 text-center">
                                ...
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 mx-auto max-w-2xl border border-green-200">
                                    <h3 className="text-3xl font-bold text-transparent bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text">
                                        {course?.course_name?.length > 50
                                            ? course?.course_name
                                            : `${course?.course_name} - Khóa học đầy đủ`}
                                    </h3>
                                </div>

                                <p className="text-lg text-gray-600 mt-8">
                                    thể hiện sự nỗ lực, kỹ năng và làm chủ kiến thức
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center mb-12 bg-gray-50 rounded-2xl p-8 mx-8">
                                <div className="flex items-center gap-3 mb-4 sm:mb-0">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-medium">Ngày cấp</p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-medium">Mã chứng chỉ</p>
                            ...
                            <div className="flex justify-center items-center">
                                <div className="text-center">
                                    ...
                                    <div className="border-t-2 border-gray-400 pt-2 w-48">
                                        <p className="text-lg font-semibold text-gray-800">Ký tên xác thực</p>
                                        <p className="text-sm text-gray-600">Nền tảng học tập</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 text-center">
                                <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full text-sm border border-green-200">
                                    ...
                                    <span>Chứng chỉ có thể được xác minh trực tuyến</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-12 bg-white rounded-2xl shadow-lg p-8">
                        <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">Về thành tích của bạn</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl">
                                <FontAwesomeIcon icon={faGraduationCap} className="text-3xl text-indigo-600 mb-3" />
                                <h4 className="font-semibold text-gray-800 mb-2">Đã hoàn thành khóa học</h4>
                                <p className="text-gray-600 text-sm">Bạn đã hoàn thành tất cả yêu cầu của khóa học</p>
                            </div>

                            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl">
                                <FontAwesomeIcon icon={faCertificate} className="text-3xl text-green-600 mb-3" />
                                <h4 className="font-semibold text-gray-800 mb-2">Chứng chỉ xác thực</h4>
                                <p className="text-gray-600 text-sm">Chứng chỉ được xác thực số và hợp lệ</p>
                            </div>

                            <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl">
                                <FontAwesomeIcon icon={faShare} className="text-3xl text-purple-600 mb-3" />
                                <h4 className="font-semibold text-gray-800 mb-2">Chia sẻ thành công</h4>
                                <p className="text-gray-600 text-sm">Giới thiệu thành tích trên mạng xã hội</p>
                            </div>
                        </div>
                    </div>
                </div>
