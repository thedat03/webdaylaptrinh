        ...
        <div>
            <div className="mb-4 p-4 bg-gray-50 rounded-lg shadow-sm">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-neutral">Thảo luận {course?.course_name}</h3>
                </div>
                <div className="flex items-center gap-4 text-sm text-gray-600">
                    <div className="flex items-center gap-1">
                        <Users className="w-4 h-4" />
                        <span>{message.filter(m => m.content.trim() !== "").length} tin nhắn</span>
                    </div>
                    <div className="flex items-center gap-1">
                ...
                <div className="flex-1">
                    <div className="relative">
                        <textarea
                            ...
                            placeholder="Chia sẻ ý kiến, đặt câu hỏi hoặc giúp đỡ mọi người..."
                            disabled={sending}
                        />
                        <button
                            onClick={addTask}
                    ...
                    <div className="flex items-center justify-between mt-2">
                        <p className="text-xs text-gray-500">
                            Nhấn <kbd className="px-2 py-1 bg-gray-100 rounded text-xs">Enter</kbd> để gửi, <kbd className="px-2 py-1 bg-gray-100 rounded text-xs">Shift + Enter</kbd> để xuống dòng
                        </p>
