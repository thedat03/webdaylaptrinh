...
INSERT INTO `learning` VALUES (_binary ':ôª\„N‚ìò±ø†\Í6à',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary ':\Ô\–\⁄EuâÉZ`U6cª',_binary 'ΩU]\ƒH\À@öé∑n∏\»_',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary '[X\r\›¡ˆOQòæ´≤πÖ–ó',_binary 'k“î≥¢Näçhn`ˇO	§',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary 'e\Ìö\ÊØÛA\ÂåFy\≈M',_binary 'EVé)3£HæjÄ\∆',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary 'î%x\ÍeYO•±f†≤Å\◊\ÿ',_binary 'k“î≥¢Näçhn`ˇO	§',_binary 'íÚ\œL\€\rF¿´…äà!Pg'),(_binary '§#\Õ¸ûFë†M\√–Ü˛[4',_binary '&\Ê_Gg\ÂL\Ì≤≤5Æ_î4',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary '\„e\ÀXµµD∫Öe\ƒyp\√ku',_binary 'vàH\”ªGàØÚ\r\r\‹_±\√',_binary 'R?¿ç!ØAWü(qâX\"\ÀÛ'),(_binary '\„–ÉdVΩG°üT\Êø“ôt',_binary 'EVé)3£HæjÄ\∆',_binary 'íÚ\œL\€\rF¿´…äà!Pg');
