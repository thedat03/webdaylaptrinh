...
INSERT INTO `course_module` VALUES (_binary '\r\◊‘Å\÷B«ì∑zûá5\Ôá',6,'H√†m',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '\Óuﬁ¥I†∫¸\ÿ{/jMj',1,'Kh√°i ni·ªám k·ªπ thu·∫≠t c·∫ßn bi·∫øt',_binary '&\Ê_Gg\ÂL\Ì≤≤5Æ_î4'),(_binary '1T–Æ6CÑ®\ﬂ	\‚&#/\’',11,'Ho√†n Th√†nh Kh√≥a H·ªçc',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '©\Ã(£IÙµ\ÿ2H¯tg',2,'Bi·∫øn v√† Ki·ªÉu d·ªØ li·ªáu',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '\◊\Z1óH\'Ö\Œvı\Ôƒô',1,'Ch∆∞∆°ng 1  Gi·ªõi thi·ªáu',_binary 't\‹|\›Ò4O8á\∆<Ö'),(_binary '¸?∂\"$Ißß]îë$ub∂',2,'M√¥i tr∆∞·ªùng , con ng∆∞·ªùi IT',_binary '&\Ê_Gg\ÂL\Ì≤≤5Æ_î4'),(_binary ' ]å¯à\ﬁOñÅù.\"1úC',5,'String',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary 'F\ÿÕç\›bN:°/\Ôƒª†',8,'Struct',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary 'Kij8EªDZ∏Dîµå:#v',3,'Ph∆∞∆°ng ph√°p ƒë·ªãnh h∆∞·ªõng',_binary '&\Ê_Gg\ÂL\Ì≤≤5Æ_î4'),(_binary 'aÄ˙ŸßäH¯èπ©\„tU\–$',7,'Con Tr·ªè',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary 'êÒÅ4LhNL∑sí|e\À',10,'H∆∞·ªõng ƒê·ªëi T∆∞·ª£ng ( OPP )',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary 'ó?.‰´∏E`©¥=Cb\¬\Âì',1,'Gi·ªõi thi·ªáu',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '\€m\Êâ¿\ÌKÓìÑ\·o¸6Ù',3,'C·∫•u tr√∫c ƒëi·ªÅu khi·ªÉn v√† v√≤ng l·∫∑p',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '¯ç\r+\œyC9Ñfãzh∫i',9,'L√†m vi·ªác v·ªõi file text',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò'),(_binary '˚\À_\Ÿ(E¶Ø1uÅ\€V¡',4,'M·∫£ng',_binary '¸≤;Yü\ÊA6øÇ3\È\Áò');
